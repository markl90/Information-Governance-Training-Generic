define([
	...
	//Session Begin
		...
		getConfig: function() {
			...
			var _nId = Adapt.offlineStorage.get('bank');
			//console.log("adapt-stateful-session.js getConfig: _nId - " + _nId);
			if (_nId != undefined) {
				(_nId == 0)?Adapt.course.get('_assessment')._bankId=1:Adapt.course.get('_assessment')._bankId=0;
			}

			//console.log("adapt-stateful-session.js getConfig: Adapt.offlineStorage.get('bank') - " + Adapt.offlineStorage.get('bank'));
			//console.log("adapt-stateful-session.js getConfig: Adapt.course.set('_assessment')._bankId - " + Adapt.course.get('_assessment')._bankId);
		},
		...
		saveSessionState: function() {
			...
			///////
			Adapt.offlineStorage.set('bank', Adapt.course.get('_assessment')._bankId);
			//console.log("adapt-stateful-session.js saveSessionState: Adapt.course.get('_assessment')._bankId - ", Adapt.course.get('_assessment')._bankId);
			//console.log("adapt-stateful-session.js saveSessionState: Adapt.offlineStorage.get('bank') - ", Adapt.offlineStorage.get('bank'));
			/////
		},
		...
		getSessionState: function() {
			//
			//Adapt.course.get('_assessment')._bankId = Adapt.offlineStorage.get('bank');
			//console.log("adapt-stateful-session.js getSessionState: Adapt.offlineStorage.get('bank') - ", Adapt.offlineStorage.get('bank') , "\n Adapt.course.get('_assessment')._bankId - " , Adapt.course.get('_assessment')._bankId);
			//
			var sessionPairs = {
