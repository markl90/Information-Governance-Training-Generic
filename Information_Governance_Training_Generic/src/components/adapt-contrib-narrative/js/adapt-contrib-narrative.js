define(function(require) {
    ...
    var Narrative = ComponentView.extend({
        ...
        postRender: function() {
            ...
            this.setupNarrative();
            /*setTimeout(function(){
                this.$('.narrative-indicators .narrative-progress').eq(0).trigger('click');
            },1000);*/
        },
        ...
        resizeControl: function() {
            ...
            //var _this = this;
            //setTimeout(function(){
                //_this.vars.niwidth = _this.$('.narrative-indicators').width();
                //console.log('**************** this.vars.niwidth: ' + _this.vars.niwidth);
            //}, 1000);
        ...
        replaceInstructions: function() {
            ...
            if (this.model.get('_isComplete') == false) {
                if (Adapt.device.screenSize !== 'large') {
                    this.$('.narrative-instruction').html(this.$('.narrative-instruction').data('mobile-instruction'));
                } else {
                    this.$('.narrative-instruction').html(this.$('.narrative-instruction').data('desktop-instruction'));
                }
            }
        ...
        replaceImages: function() {
            if (this.model.get('_isDesktop')) {
                _.each(this.model.get('_items'), function(item, i) {
                    this.$('.narrative-slider-graphic img').eq(i).attr('src', this.$('.narrative-slider-graphic img').eq(i).data('src'));
                });
            } else {
                _.each(this.model.get('_items'), function(item, i) {
                    this.$('.narrative-slider-graphic img').eq(i).attr('src', this.$('.narrative-slider-graphic img').eq(i).data('mobile-src'));
                });
            }
        },
        ...
        evaluateCompletion: function() {
            if (this.getVisitedItems().length === this.model.get('_items').length) {
                ...
                this.$('.narrative-instruction').html(this.$('.narrative-instruction').data('next-instruction'));
            }
        },
        ...
        onProgressClicked: function(event) {
            ...
            //this.vars.niwidth = this.$(event.target).parent().width();
            //console.log('this.vars.niwidth: ' + this.vars.niwidth);
        },
