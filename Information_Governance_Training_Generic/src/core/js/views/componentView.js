define(function(require) {
    ...
    var ComponentView = AdaptView.extend({
        ...
        changeInstruction: function(type) {
            if(type=="block") {
                //this.$('.block-instruction-inner').html(this.model.get('instructionFinal'));
                this.$('.component-inner').parent().parent().parent().find('.block-instruction-inner:nth-child(1)').hide();
                this.$('.component-inner').parent().parent().parent().find('.block-instruction-inner:nth-child(2)').show();
            } else {
                //this.$('.component-instruction-inner').html(this.model.get('instructionFinal'));
                this.$('.component-instruction-inner:nth-child(1)').hide();
                this.$('.component-instruction-inner:nth-child(2)').show();
            }
        }
