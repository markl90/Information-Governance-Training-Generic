    ...
    var QuestionView = ComponentView.extend({
        ...
        checkIfResetOnRevisit: function() {
            ...
            if (isResetOnRevisit) {
                ...
                var isActivityCompleted = this.model.get("_isComplete");
                if(isActivityCompleted)
                    this.model.reset("custom", true);
                else
        ...
        onSubmitClicked: function() {
            ...
            if(!$(".mcq-component."+compID).hasClass('submitted') && $((".mcq-component."+compID)).hasClass("isIntermediate")){
                $((".mcq-component."+compID)).addClass('submitted');
                $((".mcq-component."+compID)).addClass('intermediate-removed');
                return;
            }

            this.model.set("_isIntermediate", true);
        ...
        setQuestionAsHideCorrect: function() {
            ...
            if(this.model.get("_isIntermediate")){
                var screenID = this.model.get("_id");
                $(".mcq-component."+screenID).addClass("isIntermediate submitted");
            }
        },
